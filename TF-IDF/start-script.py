...
# urlSearchMain.search(path_url,path_raw_data)

if isPyICU is True:
    # STEP2: Thai Parser (LexTo)
    print "\n\n############# RUN STEP2: Thai Parser (LexTo) #############"
    wordParser_PyICU.parseAllDocuments(path_raw_data, path_parsed_words_PyICU, delimeter)
    # STEP3: N-Gram
    print "\n\n############# RUN STEP3: N-Gram #############"
    ...
    # STEP2: Thai Parser (LexTo)
    print "\n\n############# RUN STEP2: Thai Parser (LexTo) #############"
    wordParser_PyICU.parseAllDocuments(path_raw_data, path_parsed_words_Lexto, delimeter)
    # STEP3: N-Gram
    print "\n\n############# RUN STEP3: N-Gram #############"
